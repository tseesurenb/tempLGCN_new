...
tqdm.write(f"Model: {br}{MODEL}{rs} | DATASET: {br}{DATASET}{rs} | Layers: {br}{NUM_LAYERS}{rs} | DECAY: {br}{DECAY}{rs}")
tqdm.write(f"Temp: {br}{A_METHOD}{rs} - {A_BETA} | {br}{R_METHOD}{rs} - {br}{R_BETA}{rs}")
